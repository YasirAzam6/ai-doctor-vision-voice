...
def process_inputs(audio_filepath, image_file_path):
    ...
    voice_of_doctor = text_to_speech_with_elevenlabs(doctor_response, "doctor_voice.mp3")
...
iface = gr.Interface(
    ...
    outputs=[
        ...
        gr.Audio(label="Doctor_Voice.mp3")
    ],
